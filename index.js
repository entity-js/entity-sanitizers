...
loader.register('Entity/Sanitizers', function () {
  'use strict';
...
loader.register('Entity/Sanitizers/*', function (ns) {
  'use strict';

  var filename = path.join(
    __dirname, 'lib', ns.substring('Entity/Sanitizers/'.length)
  );
...
module.exports = function (core) {
  ...
  var Sanitizers = loader('Entity/Sanitizers');
  Object.defineProperty(core, 'sanitizers', {
    value: new Sanitizers(core)
  });
};
